 ...
 */
public class PDFSeparationFunction extends PDFDictionary implements PDFConstants {
    ...
    PDFSeparationFunction(PDF pdf, PDFByteWriter writer, String name, PDFObject parent,
        ...
        entry("Domain",  new Object[] { new Integer(0), new Integer(1)});   
        // Change to use RGB instead of CMYK for rendering TT
        //entry("Range", new Object[] { new Integer(0), new Integer(1), new Integer(0), new Integer(1),new Integer(0), new Integer(1),new Integer(0), new Integer(1) }); 
