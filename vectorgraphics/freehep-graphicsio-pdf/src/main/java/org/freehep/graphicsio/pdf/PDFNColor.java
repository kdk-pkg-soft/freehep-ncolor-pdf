 ...
 */
public class PDFNColor extends PDFDictionary implements PDFConstants {
    ...
    PDFNColor(PDF pdf, PDFByteWriter writer, String name, PDFObject parent,
            String[] encode, int colorSize) throws IOException {
    	super(pdf, writer);        
        this.name = name;
        object = parent;
        if (object == null)
        ...
        {
        case 7:
        	domainObjects = new Object[] { new Integer(0), new Integer(1), new Integer(0), new Integer(1),new Integer(0), new Integer(1),new Integer(0), new Integer(1),new Integer(0), new Integer(1),new Integer(0), new Integer(1),new Integer(0), new Integer(1) };
        	break;
        case 6:
        	domainObjects = new Object[] { new Integer(0), new Integer(1), new Integer(0), new Integer(1),new Integer(0), new Integer(1),new Integer(0), new Integer(1),new Integer(0), new Integer(1),new Integer(0), new Integer(1) };
        	break;        	
        default://default 5 color
        	domainObjects = new Object[] { new Integer(0), new Integer(1), new Integer(0), new Integer(1),new Integer(0), new Integer(1),new Integer(0), new Integer(1),new Integer(0), new Integer(1) };
        	break;            
        }
        entry("Domain",  domainObjects);        
        entry("Range", new Object[] { new Integer(0), new Integer(1), new Integer(0), new Integer(1),new Integer(0), new Integer(1) });                
        //startStream(encode);
