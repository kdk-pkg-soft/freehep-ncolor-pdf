...
public class TestLabels extends TestingPanel {
    ...
    private static class Paint0s0 {
        public static void paint(VectorGraphics[] vg) {
            ...
            vg[6].translate(0, 0);
            vg[6].drawImage(new BufferedImage(64, 20, BufferedImage.TYPE_INT_ARGB), 0, 0, 64, 20, 0, 0, 64, 20, null);
            vg[6].drawImage(new BufferedImage(64, 20, BufferedImage.TYPE_INT_ARGB), 64, 0, 73, 20, 0, 0, 9, 20, null);
            vg[6].translate(0, 0);
            vg[6].setFont(new Font("Dialog", 1, 12));
            vg[6].setColor(new Color(51, 51, 51, 255));
            vg[6].drawString("TestButton3", 2, 15);
            vg[6].dispose();
            vg[5].translate(0, 0);
            vg[5].setColor(new Color(166, 166, 166, 255));
            vg[5].drawLine(0, 0, 0, 19);
            vg[5].drawLine(1, 0, 72, 0);
            vg[5].setColor(new Color(116, 116, 116, 255));
            ...
            vg[5].translate(0, 0);
            vg[5].setColor(new Color(51, 51, 51, 255));
            vg[5].dispose();
            vg[4].dispose();
            ...
            vg[9].translate(0, 0);
            vg[9].drawImage(new BufferedImage(64, 20, BufferedImage.TYPE_INT_ARGB), 0, 0, 64, 20, 0, 0, 64, 20, null);
            vg[9].drawImage(new BufferedImage(64, 20, BufferedImage.TYPE_INT_ARGB), 64, 0, 73, 20, 0, 0, 9, 20, null);
            vg[9].translate(0, 0);
            ...
            vg[9].dispose();
            vg[8].translate(0, 0);
            vg[8].setColor(new Color(166, 166, 166, 255));
            ...
            vg[10].setColor(new Color(51, 51, 51, 255));
            ...
            vg[12].translate(0, 0);
            vg[12].drawImage(new BufferedImage(64, 26, BufferedImage.TYPE_INT_ARGB), 0, 0, 64, 26, 0, 0, 64, 26, null);
            vg[12].drawImage(new BufferedImage(64, 26, BufferedImage.TYPE_INT_ARGB), 64, 0, 103, 26, 0, 0, 39, 26, null);
            vg[12].translate(0, 0);
            vg[12].setFont(new Font("Dialog", 1, 12));
            vg[12].setColor(new Color(51, 51, 51, 255));
            vg[12].drawString("TestButton1", 17, 18);
            vg[12].dispose();
            vg[11].translate(0, 0);
            vg[11].setColor(new Color(122, 138, 153, 255));
            vg[11].drawRect(0, 0, 102, 25);
            vg[11].dispose();
            vg[10].dispose();
            ...
            vg[21].dispose();
            vg[20].translate(0, 0);
            vg[20].setColor(new Color(166, 166, 166, 255));
            vg[20].drawLine(0, 0, 0, 19);
            vg[20].drawLine(1, 0, 66, 0);
            vg[20].setColor(new Color(116, 116, 116, 255));
