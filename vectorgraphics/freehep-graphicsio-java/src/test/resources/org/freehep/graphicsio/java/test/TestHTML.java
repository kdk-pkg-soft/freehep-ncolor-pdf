...
public class TestHTML extends TestingPanel {
    ...
    private static class Paint0s0 {
        public static void paint(VectorGraphics[] vg) {
            ...
            vg[6].setFont(new Font("Serif", 0, 14));
            vg[6].drawChars(new char[] {
                '\n', '<', 'V', 'e', 'c', 't', 'o', 'r', 'G', 'r', 'a', 'p', 'h', 'i', 'c', 's', ' ', '&', ' ', 'A', 'd', 'a', 'p', 't', 'e', 'r'
            }, 16, 10, 96, 25);
            vg[6].setColor(new Color(0, 0, 0, 255));
            vg[6].setFont(new Font("Serif", 2, 12));
            vg[6].drawChars(new char[] {
                '\n', '<', 'V', 'e', 'c', 't', 'o', 'r', 'G', 'r', 'a', 'p', 'h', 'i', 'c', 's', ' ', '&', ' ', 'A', 'd', 'a', 'p', 't', 'e', 'r', 'C', 'a', 'r', 'd'
            }, 26, 4, 159, 32);
            vg[6].setColor(new Color(0, 0, 0, 255));
            vg[6].setFont(new Font("Serif", 0, 14));
            vg[6].drawChars(new char[] {
                '\n', '<', 'V', 'e', 'c', 't', 'o', 'r', 'G', 'r', 'a', 'p', 'h', 'i', 'c', 's', ' ', '&', ' ', 'A', 'd', 'a', 'p', 't', 'e', 'r', 'C', 'a', 'r', 'd', ' ', '=', ' ', 'e'
            }, 30, 4, 184, 25);
            vg[6].setColor(new Color(0, 0, 0, 255));
            vg[6].setFont(new Font("Serif", 0, 12));
            vg[6].drawChars(new char[] {
                '\n', '<', 'V', 'e', 'c', 't', 'o', 'r', 'G', 'r', 'a', 'p', 'h', 'i', 'c', 's', ' ', '&', ' ', 'A', 'd', 'a', 'p', 't', 'e', 'r', 'C', 'a', 'r', 'd', ' ', '=', ' ', 'e', 'x'
            }, 34, 1, 206, 17);
            vg[6].setColor(new Color(0, 0, 0, 255));
            vg[6].setFont(new Font("Serif", 0, 12));
            vg[6].drawChars(new char[] {
                '\n', '<', 'V', 'e', 'c', 't', 'o', 'r', 'G', 'r', 'a', 'p', 'h', 'i', 'c', 's', ' ', '&', ' ', 'A', 'd', 'a', 'p', 't', 'e', 'r', 'C', 'a', 'r', 'd', ' ', '=', ' ', 'e', 'x', '2'
            }, 35, 1, 211, 17);
            vg[6].setColor(new Color(0, 0, 0, 255));
            vg[6].setFont(new Font("Serif", 0, 12));
            vg[6].drawChars(new char[] {
                '\n', '<', 'V', 'e', 'c', 't', 'o', 'r', 'G', 'r', 'a', 'p', 'h', 'i', 'c', 's', ' ', '&', ' ', 'A', 'd', 'a', 'p', 't', 'e', 'r', 'C', 'a', 'r', 'd', ' ', '=', ' ', 'e', 'x', '2', 'y'
            }, 36, 1, 217, 17);
            vg[6].setColor(new Color(0, 0, 0, 255));
            vg[6].setFont(new Font("Serif", 0, 12));
            vg[6].drawChars(new char[] {
