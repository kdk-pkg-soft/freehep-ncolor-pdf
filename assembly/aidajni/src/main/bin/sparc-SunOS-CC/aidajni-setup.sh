...
export AIDAJNI_AOL=sparc-SunOS-CC
...
export LD_LIBRARY_PATH="${JDK_HOME}/jre/lib/sparc/client:${LD_LIBRARY_PATH}"
export LD_LIBRARY_PATH="${JDK_HOME}/jre/lib/sparc:${LD_LIBRARY_PATH}"

export AIDAJNI_INCLUDES=-I${AIDAJNI_HOME}/include
export AIDAJNI_LIBS="-L${AIDAJNI_HOME}/lib/${AIDAJNI_AOL} -l${AIDAJNI_NAME} -L${JDK_HOME}/jre/lib/sparc/client -ljvm"
